...
@Component({
    ...
    <!-- INICIO CABEÇALHO DA TABELA -->
        <p-toolbar styleClass="mb-6">
            <ng-template #start>
                <p-button label="Novo Cadastro
                " icon="pi pi-plus" severity="secondary" class="mr-2" (onClick)="openNew()" />
    ...
    <!-- INICIO TABELA -->
        <p-table
            ...
            [rowHover]="true"
            dataKey="id"
            currentPageReportTemplate="Visualizando {first} de {last} para {totalRecords} itens"
    ...
    <!-- INICIO MODAL CADASTRO -->
        <p-dialog [(visible)]="productDialog" [style]="{ width: '450px' }" header="Detalhes do Item" [modal]="true">
            <ng-template #content>
